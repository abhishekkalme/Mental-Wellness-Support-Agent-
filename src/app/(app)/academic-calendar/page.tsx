...
const initialEvents = [
  { id: "e1", title: "CS301 Final Exam", date: "2026-05-15", type: "exam", course: "Computer Science", location: "Hall A" },
  { id: "e2", title: "Psychology Essay Draft", date: "2026-05-08", type: "deadline", course: "Psychology", location: "Online" },
  { id: "e3", title: "Math Workshop", date: "2026-05-03", type: "lecture", course: "Mathematics", location: "Room 102" },
  { id: "e4", title: "Biology Lab Report", date: "2026-05-05", type: "deadline", course: "Biology", location: "Lab 4" },
];
              ...
              <div className="space-y-4">
                 <div className="p-4 rounded-xl bg-orange-500/10 border border-orange-500/20 space-y-2">
                    ...
                    <p className="text-xs text-foreground/80 leading-relaxed">
                       You have several tasks approaching. We've optimized your schedule for peak performance.
                    </p>
                 </div>
              </div>
           </div>
        ...
        <div className="lg:col-span-3 space-y-8">
           ...
           {events.length === 0 ? (
             <div className="glass-panel p-20 text-center flex flex-col items-center justify-center border-amber-500/10 bg-amber-500/5 shadow-2xl relative overflow-hidden rounded-[40px]">
               ...
               <h2 className="text-3xl font-bold mb-4 text-white relative z-10 tracking-tight">Calendar Empty</h2>
               <p className="text-white/40 max-w-lg mx-auto text-lg font-medium leading-relaxed relative z-10 mb-10">
                 No academic events synchronized. Connect your university account or initialize with sample schedule data.
               </p>
               <Button 
                 onClick={handleSeed}
                 disabled={isSeeding}
                ...
                {filteredEvents.map(event => (
                  <div key={event.id} className="glass-panel p-8 space-y-6 group hover:border-amber-500/20 transition-all">
                     ...
                     <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">{event.course} • {event.location}</p>
                     </div>
           ...
           {events.length > 0 && (
             <div className="glass-panel p-12 text-center border-dashed border-2 bg-secondary/10 border-border/50 space-y-4">
                ...
                <p className="text-muted-foreground italic">Maintaining balance is key during high-load weeks. Great job staying organized!</p>
             </div>
           )}
        </div>
      </div>
