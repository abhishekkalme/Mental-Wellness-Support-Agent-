  ...
  const handleSend = async (text: string) => {
    ...
    try {
      const response = await fetch('/api/chat', {
        ...
        body: JSON.stringify({ messages: store.chatHistory, chatLanguage: 'en' }),
      });
      ...
      const aiMsg: ChatMessage = {
        id: crypto.randomUUID(),
        role: 'agent',
        content: json?.reply || "I'm having trouble connecting to my servers right now.",
        timestamp: new Date().toISOString(),
      };
          ...
          <div className="h-full flex flex-col items-center justify-center max-w-2xl mx-auto text-center space-y-10">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/40 text-lg font-medium italic">
                &quot;I am the vessel for your unstructured thought. What patterns shall we observe
                today?&quot;
              </p>
            </div>
      ...
      <div className="p-8 bg-transparent shrink-0 relative z-10">
        ...
        >
          ...
          <Button
            ...
            className="w-14 h-14 rounded-full bg-[#E2FF6F] hover:bg-[#d4f056] text-black shadow-xl shadow-[#E2FF6F]/10 transition-all active:scale-90 disabled:bg-white/5 disabled:text-white/5"
          >
