...
export default function CrisisPage() {
  ...
  if (status === 'loading' || dbLoading) {
    return (
      <div className="min-h-screen bg-[#0A0C0B] flex items-center justify-center text-white/40 font-bold">
        Loading...
      </div>
    );
  }
              ...
              <div className="space-y-3">
                <div className="flex justify-center gap-2">
                  {activeModule.steps.map((_, i) => (
                    <div
                      key={i}
                      className={`h-1.5 rounded-full transition-all duration-500 ${i <= currentStep ? 'bg-[#E2FF6F] w-8' : 'bg-white/10 w-4'}`}
                    />
                  ))}
                </div>
          ...
          <>
              ...
              <div className="max-w-2xl mx-auto flex items-center justify-between">
                ...
                {locationStatus === 'denied' ? (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-white/10 bg-white/5 text-xs font-bold text-white/40"
                  >
            ...
            <div className="p-4 sm:p-6 max-w-2xl mx-auto space-y-6 mt-2">
              <section className="space-y-4">
                <a
                  href="tel:911"
                  className="w-full bg-[#111] hover:bg-[#1a1a1a] text-white p-6 rounded-3xl shadow-2xl border-2 border-rose-600/30 flex items-center justify-between active:scale-95 transition-all"
                >
                  <div>
                    <div className="text-4xl font-black tracking-tighter text-rose-500">911</div>
                    <div className="text-white/40 mt-1 font-bold tracking-widest text-sm uppercase">
                      Emergency Services
                    </div>
                  </div>
                ...
                <button
                  ...
                  className="w-full bg-[#111] hover:bg-[#1a1a1a] text-white p-6 rounded-3xl shadow-2xl border-2 border-[#25D366]/30 flex items-center justify-between active:scale-95 transition-all text-left"
                >
                  <div>
                ...
                <button
                  ...
                  className="w-full bg-[#111] hover:bg-[#1a1a1a] text-white p-5 rounded-3xl shadow-lg border border-blue-600/30 flex items-center justify-between active:scale-95 transition-all text-left"
                >
                  <div>
                    <div className="text-xl font-black tracking-tighter text-blue-400">
                      NEAREST HOSPITAL
                    </div>
                    <div className="text-white/30 mt-1 font-bold tracking-widest text-xs uppercase">
                      Open Map
                    </div>
                  </div>
                  ...
                  <div className="p-5 pt-0 border-t border-white/5 text-center">
                    <div className="relative w-40 h-40 mx-auto flex items-center justify-center my-6">
                      <motion.div
                        ...
                        animate={{
                          scale: breathingPhase === 'inhale' || breathingPhase === 'hold' ? 1.3 : 1,
                        }}
                      />
                      <motion.div
                        ...
                        transition={{
                          duration:
                            breathingPhase === 'inhale' ? 4 : breathingPhase === 'exhale' ? 8 : 1,
                        }}
                      >
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="px-2 text-white/30 text-xs hover:text-rose-400"
                        >
                          Del
                        </button>
                      </div>
                ...
                <details className="glass-panel rounded-2xl border border-white/5 overflow-hidden">
                  ...
                  <div className="p-5 pt-0 space-y-4 border-t border-white/5">
                    <div className="space-y-2">
                      <label className="text-xs uppercase tracking-widest font-bold text-white/40">
                        Warning signs
                      </label>
                      <Textarea
              ...
              {isAlertModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                  ...
                  <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    className="relative w-full max-w-sm bg-[#111] rounded-3xl shadow-2xl p-6 border border-white/10"
                  >
                    <button
                      onClick={() => {
                        setIsAlertModalOpen(false);
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <button
                        onClick={() =>
                          selectedAlertContact && sendAlert(selectedAlertContact, 'sms')
                        }
                        disabled={!selectedAlertContact}
