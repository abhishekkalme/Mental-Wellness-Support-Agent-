        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          ...
          >
            ...
            <p className="text-muted-foreground mt-2">
              A proven technique to reduce anxiety and help you relax or sleep.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-muted-foreground mt-2">
              Engage your senses to quickly anchor yourself in the present moment.
            </p>
          </div>
        </div>
      )}
        ...
        <motion.div
          animate={
            !playing
              ? { scale: 1, opacity: 0.5 }
              : phase === 'inhale'
                ? { scale: 2, opacity: 1, backgroundColor: 'var(--color-primary)' }
                : phase === 'hold'
                  ? { scale: 2, opacity: 0.8, backgroundColor: 'var(--color-primary)' }
