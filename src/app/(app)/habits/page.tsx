...
export default function HabitsPage() {
  ...
  return (
    <main
      id="main-content"
      className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto space-y-6 lg:space-y-8 relative"
    >
      ...
      {items.length === 0 ? (
        <div className="surface-card p-12 md:p-16 text-center border-2 border-dashed border-white/[0.06] relative z-10">
        ...
        <div className="space-y-3 relative z-10">
          {items.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className={`surface-card p-4 md:p-5 hover:border-white/20 transition-all duration-300 ${isFullyComplete ? 'ring-1 ring-[#E2FF6F]/20' : ''}`}
              >
                    ...
                    <div className="text-center">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-20 h-2 bg-white/10 rounded-full overflow-hidden">
                          <div
                            className={`h-full rounded-full transition-all duration-1000 ${isFullyComplete ? 'bg-[#E2FF6F]' : 'bg-[#E2FF6F]/60'}`}
      ...
      {showAddModal && (
        <div
          ...
          aria-modal="true"
        >
          <div ref={modalRef} className="surface-card p-6 md:p-8 w-full max-w-md space-y-6">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 bg-white/10 rounded-full appearance-none cursor-pointer accent-[#E2FF6F] [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[#E2FF6F] [&::-webkit-slider-thumb]:shadow-lg [&::-webkit-slider-thumb]:shadow-[#E2FF6F]/30 [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-[#E2FF6F] [&::-moz-range-thumb]:border-0"
                />
