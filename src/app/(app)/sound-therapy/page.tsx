...
const soundAssets: SoundAsset[] = [
  { id: "rain", name: "Rainfall", icon: CloudRain, color: "text-blue-500", gradient: "from-blue-500/20 to-cyan-500/10" },
  { id: "forest", name: "Forest Birds", icon: Trees, color: "text-emerald-500", gradient: "from-emerald-500/20 to-teal-500/10" },
  { id: "ocean", name: "Ocean Waves", icon: Waves, color: "text-sky-500", gradient: "from-sky-500/20 to-blue-500/10" },
  { id: "wind", name: "Soft Wind", icon: Wind, color: "text-slate-400", gradient: "from-slate-400/20 to-slate-200/10" },
  { id: "fire", name: "Crackling Fire", icon: Flame, color: "text-orange-500", gradient: "from-orange-500/20 to-red-500/10" },
];
    ...
    <main className="p-8 max-w-6xl mx-auto space-y-10">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-lg italic">Create your perfect restorative atmosphere.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {soundAssets.map((sound) => {
          ...
          return (
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${sound.gradient} opacity-0 group-hover:opacity-100 transition-opacity`} />
      ...
      <div className="glass-panel p-8 bg-blue-500/5 border-blue-500/20 rounded-3xl flex flex-col md:flex-row items-center gap-8">
         ...
         <div className="space-y-1 text-center md:text-left">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              For maximum focus, try setting <strong>Rain</strong> to 60%, <strong>Soft Wind</strong> to 30%, and a touch of <strong>Forest Birds</strong> at 10%. This creates a rich, natural soundscape that masks distracting frequencies.
            </p>
         </div>
      </div>
    </main>
