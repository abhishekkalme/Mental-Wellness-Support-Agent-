        ...
        <div className="max-w-7xl mx-auto space-y-16 md:space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                title: 'Sleep Stories',
                desc: 'Narrated journeys designed to lulls your conscious mind into deep rest.',
                icon: '🌙',
              },
              {
                title: 'Progress Library',
                desc: 'Archive your growth and celebrate small wins in your wellness journey.',
                icon: '📖',
              },
            ].map((f, i) => (
              <motion.div
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              <Button className="bg-[#E2FF6F] text-black hover:bg-[#d4f056] font-bold rounded-full px-10 h-16 text-lg">
                Download App
              </Button>
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#E2FF6F]/20 flex items-center justify-center font-bold text-[#E2FF6F]">
                    {t.name[0]}
                  </div>
