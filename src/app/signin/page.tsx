        ...
        <div className="glass-panel p-8 text-center flex flex-col items-center gap-6">
          ...
          {needsVerification && (
            <div className="w-full p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 space-y-3">
              ...
              {resent ? (
                <p className="text-xs text-emerald-600">Verification email sent!</p>
              ) : (
                <button
                  type="button"
                  onClick={handleResendVerification}
                  disabled={resending}
                  className="text-xs text-[#E2FF6F] hover:underline disabled:opacity-50 flex items-center gap-1"
                >
