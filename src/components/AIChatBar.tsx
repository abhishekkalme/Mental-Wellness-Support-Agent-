    ...
    >
      ...
      <div className="flex-1 space-y-4 md:space-y-6 relative z-10 w-full">
        <div className="flex flex-col gap-1">
          ...
          <span className="text-white/40 font-medium text-xs md:text-sm tracking-wide">I'm here to listen. What's on your mind today?</span>
        </div>
        ...
        <div className="relative flex items-center gap-4">
          ...
          />
          <button className="absolute right-2 md:right-3 w-10 h-10 md:w-12 md:h-12 bg-[#E2FF6F] text-black rounded-[18px] flex items-center justify-center hover:bg-[#d4f056] hover:scale-105 active:scale-95 transition-all shadow-lg shadow-[#E2FF6F]/20">
