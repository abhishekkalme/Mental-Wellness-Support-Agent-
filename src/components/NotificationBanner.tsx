...
import { Bell, X, AlertCircle, CheckCircle2, Sparkles } from 'lucide-react';
    ...
    const demos: Notification[] = [
      {
        id: '1',
        title: 'Daily Habit',
        message: 'Time for your morning meditation streak!',
        type: 'info',
        timestamp: new Date(),
      },
      {
        id: '2',
        title: 'Mood Check-in',
        message: "You haven't logged your mood in 3 hours. How are you feeling?",
        type: 'warning',
        timestamp: new Date(),
      },
      {
        ...
        message: "Congrats! You've reached a 3-day breathing streak.",
        type: 'success',
        timestamp: new Date(),
      },
    ];
          ...
          >
            <div className="glass-panel p-5 bg-background shadow-2xl relative border-primary/20 group">
              ...
              <div className="flex gap-4">
                <div
                  className={`p-3 rounded-full h-fit flex items-center justify-center ${
                    note.type === 'success'
