...
import { BookText, Flower2, Leaf, ArrowRight, Wind, Coffee, Moon } from 'lucide-react';
...
const ActivityCard = ({
  ...
  >
    ...
    <div className="flex justify-between items-start relative z-10">
      <div
        className={`w-14 h-14 ${color} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-700 shadow-lg`}
      >
